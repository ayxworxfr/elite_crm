export default {
  ...
  'menu.crm': 'Gestão de Clientes',
  'menu.crm.client': 'Lista de Clientes',
  'menu.crm.import': 'Importar',
  'menu.system': 'Gestão do Sistema',
  'menu.system.user': 'Gestão de Usuários',
  'menu.system.role': 'Gestão de Funções',
  'menu.system.permission': 'Gestão de Permissões',
